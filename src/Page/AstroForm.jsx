...
const Star = ({ style }) => (
    <div
        className="absolute bg-white rounded-full opacity-0 star-twinkle"
        style={style}
    />
);
        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-gray-900 via-indigo-950 to-black relative overflow-hidden p-4">
            ...
            >
              ...
              ${loading
                ...
                {/* Error */}
                {error && <p className="text-red-400 mt-6 text-center font-medium border border-red-500/50 bg-red-900/20 p-3 rounded-lg">{error}</p>}
